 ...
 * @author howard
 */
public class AttendanceChoice extends javax.swing.JFrame {
    ...
    private void ADDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ADDActionPerformed
        // TODO add your handling code here:
        dataInput.Attendance att = new dataInput.Attendance();
        att.setVisible(true);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AttendanceChoice.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AttendanceChoice().setVisible(true);
            }
        });
    }
