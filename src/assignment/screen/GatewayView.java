 ...
 * @author howard
 */
public class GatewayView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GatewayView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
